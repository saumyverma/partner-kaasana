        ...
        <div className="sidebar-menu-area">
          <ul className="sidebar-menu" id="sidebar-menu">
            {menuList?.map((menu, index) => {
              const mainMenuLink = menu?.menu_link
                ? `/${menu?.menu_link}`
                : "#";

              return (
                <li
                  className={` ${menu?.subMenu.length > 0 ? "dropdown" : ""} ${
                    pathname === mainMenuLink ? "active-page" : ""
                  }`}
                  key={index}
                >
                  <Link
                      ...
                      {menu?.subMenu?.map((subMenu, subIndex) => {
                        ...
                        return (
                          <li key={subIndex}>
                            ...
                            >
                              <i
                                className={`ri-circle-fill circle-icon ${dotClass} w-auto`}
                              />
                              {subMenu?.menu_name}
                            </Link>
                          </li>
