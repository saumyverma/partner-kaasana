...
import AddLeadReportsModal from "./AddLeadReportsModal";
      ...
      <div className='col-xxl-3'>
        <div className='card h-100 p-0'>
          <div className='card-body p-24'>
            <h6 className='text-lg fw-semibold mb-16'>Lead Report Filters</h6>
            <div className='mb-16'>
              <label className='form-label text-sm fw-medium'>Lead Name</label>
              <input
                type='text'
          ...
          <div className='card-header d-flex flex-wrap align-items-center justify-content-between gap-3'>
            ...
            <div className='d-flex flex-wrap align-items-center gap-3'>
              <button
                ...
                data-bs-target='#addLeadReportsModal'
              >
                <i className='ri-add-line' /> Create Lead Report
              </button>
            </div>
          </div>
