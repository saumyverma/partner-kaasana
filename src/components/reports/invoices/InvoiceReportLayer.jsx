...
import AddInvoiceReportModal from "./AddInvoiceReportModal";
      ...
      <div className='col-xxl-3'>
        <div className='card h-100 p-0'>
          <div className='card-body p-24'>
            <h6 className='text-lg fw-semibold mb-16'>Invoice Report Filters</h6>
            <div className='mb-16'>
              <label className='form-label text-sm fw-medium'>Report Name</label>
              <input
                type='text'
            ...
            <div className='mb-16'>
              <label className='form-label text-sm fw-medium'>From Date</label>
              <input type='date' className='form-control form-control-sm' />
            </div>
            <div className='mb-16'>
              <label className='form-label text-sm fw-medium'>To Date</label>
              <input type='date' className='form-control form-control-sm' />
            </div>
          ...
          <div className='card-header d-flex flex-wrap align-items-center justify-content-between gap-3'>
            ...
            <div className='d-flex flex-wrap align-items-center gap-3'>
              <button
                ...
                data-bs-target='#addInvoiceReportModal'
              >
                <i className='ri-add-line' /> Create Invoice Report
              </button>
            </div>
          </div>
            ...
            <table className='table bordered-table mb-0'>
              ...
              <tbody>
                <tr>
                  ...
                  <td>Monthly invoice report for January 2024</td>
                  <td>
