...
import AddSalesReportModal from "./AddSalesReportModal";
      ...
      <div className='col-xxl-3'>
        <div className='card h-100 p-0'>
          <div className='card-body p-24'>
            <h6 className='text-lg fw-semibold mb-16'>Sales Report Filters</h6>
            <div className='mb-16'>
          ...
          <div className='card-header d-flex flex-wrap align-items-center justify-content-between gap-3'>
            ...
            <div className='d-flex flex-wrap align-items-center gap-3'>
              <button
                ...
                data-bs-target='#addSalesReportModal'
              >
                <i className='ri-add-line' /> Create Sales Report
              </button>
            </div>
          </div>
            ...
            <table className='table bordered-table mb-0'>
              ...
              <tbody>
                <tr>
                  ...
                  <td>Monthly sales report for January 2024</td>
                  <td>
