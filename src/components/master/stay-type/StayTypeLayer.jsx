...
import AddStayTypeModal from "./AddStayTypeModal";

export default function StayTypeLayer({ pageId }) {
  return (
    <div className='row gy-4'>
      <div className='col-xxl-3'>
        <div className='card h-100 p-0'>
          <div className='card-body p-24'>
            <h6 className='text-lg fw-semibold mb-16'>Stay Type Filters</h6>
            <div className='mb-16'>
              <label className='form-label text-sm fw-medium'>Stay Type Name</label>
              <input
                type='text'
                className='form-control form-control-sm'
                placeholder='Search by stay type'
              />
            </div>
            <div className='mb-16'>
          ...
          <div className='card-header d-flex flex-wrap align-items-center justify-content-between gap-3'>
            ...
            <div className='d-flex flex-wrap align-items-center gap-3'>
              <button
                ...
                data-bs-target='#addStayTypeModal'
              >
                <i className='ri-add-line' /> Create Stay Type
              </button>
            </div>
          </div>
            ...
            <table className='table bordered-table mb-0'>
              <thead>
                <tr>
                  ...
                  <th scope='col'>Stay Type Name</th>
