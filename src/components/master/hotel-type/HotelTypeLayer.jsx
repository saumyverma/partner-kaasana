...
import AddHotelTypeModal from "./AddHotelTypeModal";
      ...
      <div className='col-xxl-3'>
        <div className='card h-100 p-0'>
          <div className='card-body p-24'>
            <h6 className='text-lg fw-semibold mb-16'>Hotel Type Filters</h6>
            <div className='mb-16'>
              <label className='form-label text-sm fw-medium'>Hotel Type Name</label>
              <input
                type='text'
        ...
        <div className='card h-100 p-0'>
          <div className='card-header d-flex flex-wrap align-items-center justify-content-between gap-3'>
            ...
            <div className='d-flex flex-wrap align-items-center gap-3'>
              ...
              >
                <i className='ri-add-line' /> Create Hotel Type
              </button>
            </div>
          </div>
            ...
            <table className='table bordered-table mb-0'>
              <thead>
                <tr>
                  ...
                  <th scope='col'>Hotel Type Name</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td>Luxury hotel type with premium amenities</td>
                  <td>
