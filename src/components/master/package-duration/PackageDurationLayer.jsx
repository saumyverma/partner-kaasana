...
import AddPackageDurationModal from "./AddPackageDurationModal";

export default function PackageDurationLayer({ pageId }) {
  return (
    <div className='row gy-4'>
      <div className='col-xxl-3'>
        <div className='card h-100 p-0'>
          <div className='card-body p-24'>
            <h6 className='text-lg fw-semibold mb-16'>Package Duration Filters</h6>
            <div className='mb-16'>
              <label className='form-label text-sm fw-medium'>Duration Name</label>
              <input
                type='text'
          ...
          <div className='card-header d-flex flex-wrap align-items-center justify-content-between gap-3'>
            ...
            <div className='d-flex flex-wrap align-items-center gap-3'>
              <button
                ...
                data-bs-target='#addPackageDurationModal'
              >
                <i className='ri-add-line' /> Create Package Duration
              </button>
            </div>
          </div>
            ...
            <table className='table bordered-table mb-0'>
              ...
              <tbody>
                <tr>
                  ...
                  <td>3 days and 2 nights package duration</td>
                  <td>
