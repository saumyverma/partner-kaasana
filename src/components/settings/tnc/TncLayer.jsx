...
import AddTncModal from "./AddTncModal";

export default function TncLayer() {
  return (
    <div className='row gy-4'>
      <div className='col-xxl-3'>
        <div className='card h-100 p-0'>
          <div className='card-body p-24'>
            <h6 className='text-lg fw-semibold mb-16'>TNC Filters</h6>
            <div className='mb-16'>
            ...
            <div className='mb-16'>
              <label className='form-label text-sm fw-medium'>Category</label>
          ...
          <div className='card-header d-flex flex-wrap align-items-center justify-content-between gap-3'>
            ...
            <div className='d-flex flex-wrap align-items-center gap-3'>
              <button
                ...
                data-bs-target='#addTncModal'
              >
                <i className='ri-add-line' /> Create TNC
              </button>
            </div>
          </div>
